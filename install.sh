...
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}========= III   MMMM   MMMM      AA       MMMM   MMMM ======================${NC}"   
echo -e "${GREEN}========= III   MMMMM MMMMM     AA AA     MMMMM MMMMM ======================${NC}" 
echo -e "${GREEN}========= III   MMM  M  MMM    AA   AA    MMM  M  MMM ======================${NC}"
echo -e "${GREEN}========= III   MMM     MMM   AAAAAAAAA   MMM     MMM ======================${NC}"
echo -e "${GREEN}========= III   MMM     MMM  AA       AA  MMM     MMM ======================${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}========================= . Info 089-613-232-182 ===========================${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}${NC}"
...
echo -e "${GREEN}=================== Informasi: Whatsapp 089613232182 =======================${NC}"
echo -e "${GREEN}============================================================================${NC}"
